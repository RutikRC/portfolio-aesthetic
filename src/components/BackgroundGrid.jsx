...
export default function BackgroundGrid() {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden" aria-hidden="true">
      {/* App background */}
      <div className="absolute inset-0 bg-[#090a0f] transition-colors duration-500" />
      ...
      <div className="absolute -top-32 -left-32 h-[520px] w-[520px] rounded-full bg-[radial-gradient(circle,rgba(99,102,241,0.055),transparent_70%)] blur-3xl" />
      <div className="absolute -bottom-40 -right-32 h-[560px] w-[560px] rounded-full bg-[radial-gradient(circle,rgba(168,85,247,0.05),transparent_70%)] blur-3xl" />
