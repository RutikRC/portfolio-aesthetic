      ...
      <div className="text-left">
            ...
            return (
              <button
                ...
                className={`inline-flex items-center gap-2 rounded-full border px-4 py-2 text-xs font-semibold transition-all duration-300 ${
                  activeTab
                    ? "border-violet-500/40 bg-violet-500/10 text-violet-300 shadow-glow"
        ...
        <div className="mt-8 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-xs text-slate-500">{active.tagline}</p>
          </div>
            ...
            <AnimatePresence mode="popLayout">
              {active.tools.map((tool) => (
                <motion.div
                  ...
                  className="group relative overflow-hidden rounded-xl border border-white/5 bg-white/[0.03] p-5 transition-all duration-300 hover:border-violet-500/30 hover:bg-white/[0.06]"
                >
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <span className="mt-1 inline-block rounded bg-violet-500/10 px-1.5 py-0.5 font-mono text-[9px] font-medium uppercase tracking-wider text-violet-300">
                        {tool.role}
                      </span>
                    </div>
                    <span className="font-mono text-[10px] text-slate-600 transition-colors group-hover:text-violet-400">
        ...
        <div className="mt-12 flex flex-wrap items-center gap-x-6 gap-y-2 rounded-xl border border-white/5 bg-white/[0.02] px-5 py-4">
